...
@Component({
  selector: 'app-c06members',
  templateUrl: './c06members.component.html',
  styleUrls: ['./c06members.component.scss']
})
export class C06membersComponent implements OnInit {
  asIs(a,b) {
    return a
  }
  buttDisabled = true;
  ...
  membertypelist: any = {
    a: {
      ...
      selectedview: this.dataservice.allData.info_details.c06menbers === "a"
    },
    b: {
      title: 'my partner',
      ...
      selectedview: this.dataservice.allData.info_details.c06menbers === "b"
    },
    c: {
      ...
      selectedview: this.dataservice.allData.info_details.c06menbers === "c"
    },
    d: {
      title: 'my kids',
      message: 'Great, they’ll be covered by your Lemonade policy 🙂',
      ...
      selectedview: this.dataservice.allData.info_details.c06menbers === "d"
    },
    e: {
      title: 'other',
      ...
      selectedview: this.dataservice.allData.info_details.c06menbers === "e"
    }
  };
  ...
  changed(key: string) {
    this.dataservice.allData.info_details.c06menbers = key;
