...
export class C06membersComponent implements OnInit {
  ...
  membertypelist: any = {
    a: {
      ...
      selectedview: this.dataservice.allData.c06members === "a"
    },
    b: {
      title: 'my partner',
      ...
      selectedview: this.dataservice.allData.c06members === "b"
    },
    c: {
      ...
      selectedview: this.dataservice.allData.c06members === "c"
    },
    d: {
      title: 'my kids',
      message: 'Great, they’ll be covered by your Lemonade policy 🙂',
      ...
      selectedview: this.dataservice.allData.c06members === "d"
    },
    e: {
      title: 'other',
      ...
      selectedview: this.dataservice.allData.c06members === "e"
    }
  };
  ...
  ngOnInit(): void {
    ...
    if (this.dataservice.allData.c06members.length > 0) this.buttDisabled = false;
  }

  changed(key: string) {
    this.dataservice.allData.c06members = key;
