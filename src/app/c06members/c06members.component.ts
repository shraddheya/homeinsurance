...
export class C06membersComponent implements OnInit {
  ...
  membertypelist: any = {
    a: {
      ...
      selectedview: this.dataservice.allData.c06menbers === "a"
    },
    b: {
      title: 'my partner',
      ...
      selectedview: this.dataservice.allData.c06menbers === "b"
    },
    c: {
      ...
      selectedview: this.dataservice.allData.c06menbers === "c"
    },
    d: {
      title: 'my kids',
      message: 'Great, they’ll be covered by your Lemonade policy 🙂',
      ...
      selectedview: this.dataservice.allData.c06menbers === "d"
    },
    e: {
      title: 'other',
      ...
      selectedview: this.dataservice.allData.c06menbers === "e"
    }
  };
  ...
  changed(key: string) {
    this.dataservice.allData.c06menbers = key;
