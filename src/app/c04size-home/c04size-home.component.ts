...
export class C04sizeHomeComponent implements OnInit {
  ...
  sizeForm = new FormGroup({
    size: new FormControl(this.dataservice.allData.info_details["c04size-home"], Validators.required),
  })
  ...
  clicked() {
    this.dataservice.allData.info_details["c04size-home"] = this.sizeForm.value.size;
