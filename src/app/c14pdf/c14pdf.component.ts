...
export class C14pdfComponent implements OnInit {
    ...
    data:{
      page2:{
        ...
        table:{ // need to add
          ...
          data:{
            'Contents - Low Value Items': this.dataservice.allData['c10quote-detail'].q01coverageamount['CONTENTS'] || 0,
            'Personal Liability ': this.dataservice.allData['c10quote-detail'].q01coverageamount['PERSONAL LIABILITY'] || 0,
            'Temporary Accomodation': this.dataservice.allData['c10quote-detail'].q01coverageamount['TEMP ACCOMMODATION'] || 0,
            'Contents - High Value Items (Jewlery)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Jewlery'] || 0,
            'Contents - High Value Items (Bicycles)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Bicycles'] || 0,
            'Contents - High Value Items (Cameras)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Cameras'] || 0,
            'Contents - High Value Items (Electronics)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Electronics'] || 0,
            'Contents - High Value Items (Music Equipment)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Music Equipment'] || 0,
            'Contents - High Value Items (Other)': this.dataservice.allData['c10quote-detail'].q02highvalueitems['Other'] || 0,
          },
  ...
  ngOnInit(): void {
    ...
    hvi.personalliability.filter((it: any) => {
      return it.insurance_value ===     this.dataservice.allData['c10quote-detail'].q01coverageamount['PERSONAL LIABILITY']
    })[0].price_month +
    hvi.temporary_accomodation.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q01coverageamount['TEMP ACCOMMODATION']
    })[0].price_month +
    hvi.content_lowvalue.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q01coverageamount['TEMP ACCOMMODATION']
    })[0].price_month +
    hvi.jewellery.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Jewlery']
    })[0].price_month +
    hvi.bicycles.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Bicycles']
    })[0].price_month +
    hvi.cameras.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Cameras']
    })[0].price_month +
    hvi.electronics.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Electronics']
    })[0].price_month +
    hvi.music.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Music Equipment']
    })[0].price_month +
    hvi.other.filter((it: any) => {
      return it.insurance_value === this.dataservice.allData['c10quote-detail'].q02highvalueitems['Other']
    })[0].price_month +
    0
  }
