...
export class C11builthomeYearComponent implements OnInit {
  ...
  yearForm = new FormGroup({
    builtyear: new FormControl(this.dataservice.allData["c11builthome-year"] || 2020, Validators.compose([Validators.required, Validators.min(1980), Validators.max(2019)])),
  })
