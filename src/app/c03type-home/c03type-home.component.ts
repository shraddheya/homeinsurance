...
export class C03typeHomeComponent implements OnInit {
  ...
  hometype = {
    Apartment: {
      ...
      selectedview: this.dataservice.allData.info_details["c03type-home"] === "Apartment"
    },
    'Single family house': {
      ...
      selectedview: this.dataservice.allData.info_details["c03type-home"] === "Single family house"
    },
    Duplex: {
      ...
      selectedview: this.dataservice.allData.info_details["c03type-home"] === "Duplex"
    }
  };
  ...
  changed(key: string) {
    this.dataservice.allData.info_details["c03type-home"] = key;
