...
export class Q03superpowersComponent implements OnInit {
  ...
  superpowerArray: any = {
    "ANTI THEFT PACKAGE": {
      ...
      price: "2,00 €/MO",
      showchecked: this.dataservice.allData["c10quote-detail"].q03superpowers.indexOf("ANTI THEFT PACKAGE") > -1,
    },
    "EXTREME WEATHER PACKAGE": {
      ...
      price: "1,00 €/MO",
      showchecked: this.dataservice.allData["c10quote-detail"].q03superpowers.indexOf("EXTREME WEATHER PACKAGE") > -1,
    }
  }
